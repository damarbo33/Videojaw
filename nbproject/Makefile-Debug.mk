...
${OBJECTDIR}/VideoTranscoder.o: VideoTranscoder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VideoTranscoder.o VideoTranscoder.cpp
